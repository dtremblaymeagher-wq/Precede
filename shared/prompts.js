...
- strategic_alignment_summary — What the OKR scores reveal about strategic direction. Derived exclusively from okr_alignment scores and their rationales. Does not repeat signals from summary. Does not invent numbers or metrics absent from the input. CRITICAL: OKR scores (0–100) are signal alignment indicators, NOT performance percentages or achievement rates — never write "55% interview volume" or "45% offer conversion" from a score of 55 or 45. Describe direction and relative strength only (e.g. "strong signal support", "weak evidence", "no signal").
